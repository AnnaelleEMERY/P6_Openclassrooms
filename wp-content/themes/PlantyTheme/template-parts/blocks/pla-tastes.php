...
<section class="<?php echo esc_attr($className); ?> bg-secondary" id="<?php echo esc_attr($id); ?>">
    <div class="container text-center">
        ...
        <div class="row row-cols-1 row-cols-sm-2">
            ...
            <div class="col">
                <img class="w-100 canette" src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/fraises.png" width="394" height="263" alt="fraises">
            </div>

            <div class="col">
                <img class="w-100 canette" src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/pamplemousses.png" width="394" height="263" alt="pamplemousses">
            </div>

            <div class="col">
                <img class="w-100 canette" src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/framboises.png" width="394" height="263" alt="framboises">
            </div>
